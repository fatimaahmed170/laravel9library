    ...
    <div class="container">
        ...
        <div class="row border">
            ...
            <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                <div class="about-box">
                    <figure><img src="{{asset('assets')}}/img/about.png" alt="img"/></figure>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    <div class="Library-box">
                        <figure><img src="{{asset('assets')}}/img/Library-.jpg" alt="#"/></figure>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row box">
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                <div class="book-box">
                    <figure><img src="{{asset('assets')}}/img/book-1.jpg" alt="img"/></figure>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="book-box">
                    <figure><img src="{{asset('assets')}}/img/book-2.jpg" alt="img"/></figure>
                </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                <div class="book-box">
